        ...
        for (var key in data) {
            ...
            if ((newKey--) == countryId) {
                ...
                var profile = '<div class="person-list-item">' +
                            '<p id="countryName" style="margin-left: 20%;"><i class="fa fa-info"></i> Name: ' + countryData.name + '</p>' +
                            '<p class="white" style="margin-left: 20%;" id="region"><i class="fa fa-globe"></i> Region: ' + countryData.region + '</p>' +
                            '<p class="white" style="margin-left: 20%;" id="capitalCity"><i class="fa fa-map-marker"></i> Capital: ' + countryData.capital + '</p>' +
                            '<p class="white" style="margin-left: 20%;" id="povertyLine"> Poverty Line:  </p>' +
                            '<p class="white" style="margin-left: 20%;" id="gdpPerCapita"> GDP Per Capita:  </p>' +
