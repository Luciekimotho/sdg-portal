        ...
        for (var key in data) {
            ...
            if ((newKey--) == countryId) {
                ...
                var profile = '<div class="person-list-item">' +
                    '<h3 id="countryName" style="margin-left: 20%;"><i class="fa fa-info"></i> Name: ' + countryData.name + '</h3>' +
                    '<h3 class="white" style="margin-left: 20%;" id="region"><i class="fa fa-globe"></i> Region: ' + countryData.region + '</h3>' +
                    '<h3 class="white" style="margin-left: 20%;" id="capitalCity"><i class="fa fa-map-marker"></i> Capital: ' + countryData.capital + '</h3>' +
                    '<h3 class="white" style="margin-left: 20%;" id="povertyLine"> Poverty Line:  </h3>' +
                    '<h3 class="white" style="margin-left: 20%;" id="gdpPerCapita"> GDP Per Capita:  </h3>' +
                    '</div>';
                var flagURL = '<img src="'+'../' + countryData.flagURL + '" class="img-fluid" style="max-width:200px;max-height:150px;float: right;margin-right: 8%;margin-top: 1%;margin-bottom: 1%;">';
